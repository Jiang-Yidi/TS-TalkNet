...
from ava_ts_dataLoader import train_loader, val_loader
...
def main():
    ...
    parser.add_argument('--enroll_speech_folder',  type=str, default="./enroll_speech_folder", help='Save path of enroll speech folder')
    ...
    loader = train_loader(trialFileName = args.trainTrialAVA, \
                          ...
                          enroll_speech_folder = os.path.join(args.enroll_speech_folder, 'train'), \
                          **vars(args))
    ...
    loader = val_loader(trialFileName = args.evalTrialAVA, \
                        ...
                        enroll_speech_folder = os.path.join(args.enroll_speech_folder, args.evalDataType), \
                        **vars(args))
